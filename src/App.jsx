...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={() => setDark(d => !d)}
      className="fixed bottom-16 left-4 z-50 w-10 h-10 rounded-full bg-gray-800 dark:bg-yellow-400 text-white dark:text-gray-900 flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
...
function LiveChatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-36 right-4 sm:right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe57] text-white px-3 py-2 rounded-full shadow-xl transition-all hover:scale-105 active:scale-95 font-semibold text-xs"
    >
